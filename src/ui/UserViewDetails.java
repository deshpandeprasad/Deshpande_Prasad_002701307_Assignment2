...
public class UserViewDetails extends javax.swing.JPanel {
    ...
    /**
     * Creates new form UserViewDetails
     */
    ...
    public UserViewDetails(CityDirectory cityDir,PatientDirectory patDir,PersonDirectory perDir,
        ...
        txtName1.setText(patobj.getName());
        txtUserName1.setText(patobj.getUserName());
        txtPassword1.setText(patobj.getPassword());
       
       txtDob1.setDate(patobj.getDob());
        txtSSN1.setText(String.valueOf(patobj.getId()));
        txtAge1.setText(String.valueOf(patobj.getAge()));
        txtProblem1.setText(patobj.getProblem());
        cbGender1.setSelectedItem(patobj.getGender());
        cbCity.setSelectedItem(patobj.getResidence().getCityName());
        cbComm.setSelectedItem(patobj.getResidence().getCommName());
        cbHouse.setSelectedItem(patobj.getResidence().getHouseno());
    }
