 ...
 * @author prasad
 */
public class CreateHospAdJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CreateHospAdJPanel
     */
    ...
    public CreateHospAdJPanel(CityDirectory cityDir,PatientDirectory patDir,PersonDirectory perDir,HouseDirectory houseDir,EncounterHistory encHist,CommunityDirectory commDir,DoctorDirectory docDir,HospitalDirectory hospDir) {
        initComponents();
    ...
    private void btnCreatePatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreatePatientActionPerformed
        ...
        Person per = new Person(name,userName, pass, null,null,0,null,"hospital admin");
        perDir.addPerson(per);
        JOptionPane.showMessageDialog(this, "Hospital Admin added successfully!");
